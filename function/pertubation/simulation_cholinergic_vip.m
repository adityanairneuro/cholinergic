function [CC_All, CS_All] = simulation_cholinergic_vip(i_curr)
    load('params_vip.mat');
    CC_All = zeros(1,36);
    CS_All = zeros(1,36);
    jValues = 50:10:400;
...
%% Ctrl Signal
    ...
    params.ACh = 0;
    dynamics = integrate_dynamics_revised_cla_vip(Wsoc, params, X0, It,input_signal);
    f_rates = dynamics.r;
...
%% Ctrl Noise
    ...
    params.ACh = 0;
    dynamics = integrate_dynamics_revised_cla_vip(Wsoc, params, X0, It,input_noise);
    f_rates = dynamics.r;
